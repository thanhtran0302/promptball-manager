...
export const FORMATION_SLOTS: Record<Formation, Slot[]> = {
  ...
  '4-1-4-1': [
    ...
    { x: 0.15, y: 0.62, role: 'DF', label: 'DC' },
    { x: 0.18, y: 0.84, role: 'DF', label: 'DD' },
    { x: 0.30, y: 0.5, role: 'MD', label: 'MDC' },
    { x: 0.48, y: 0.14, role: 'MD', label: 'MG' },
    { x: 0.45, y: 0.38, role: 'MD', label: 'MC' },
    { x: 0.45, y: 0.62, role: 'MD', label: 'MC' },
    { x: 0.48, y: 0.86, role: 'MD', label: 'MD' },
    { x: 0.68, y: 0.5, role: 'AT', label: 'BU' },
  ],
  '4-4-1-1': [
    { x: 0.04, y: 0.5, role: 'GK', label: 'G' },
    ...
    { x: 0.15, y: 0.62, role: 'DF', label: 'DC' },
    { x: 0.18, y: 0.84, role: 'DF', label: 'DD' },
    { x: 0.44, y: 0.14, role: 'MD', label: 'MG' },
    { x: 0.40, y: 0.38, role: 'MD', label: 'MC' },
    { x: 0.40, y: 0.62, role: 'MD', label: 'MC' },
    { x: 0.44, y: 0.86, role: 'MD', label: 'MD' },
    { x: 0.58, y: 0.5, role: 'MD', label: 'MC' },
    { x: 0.70, y: 0.5, role: 'AT', label: 'BU' },
  ],
  '4-5-1': [
    { x: 0.04, y: 0.5, role: 'GK', label: 'G' },
    { x: 0.18, y: 0.16, role: 'DF', label: 'DG' },
    ...
    { x: 0.15, y: 0.62, role: 'DF', label: 'DC' },
    { x: 0.18, y: 0.84, role: 'DF', label: 'DD' },
    { x: 0.46, y: 0.12, role: 'MD', label: 'MG' },
    { x: 0.40, y: 0.34, role: 'MD', label: 'MC' },
    { x: 0.36, y: 0.5, role: 'MD', label: 'MDC' },
    { x: 0.40, y: 0.66, role: 'MD', label: 'MC' },
    { x: 0.46, y: 0.88, role: 'MD', label: 'MD' },
    { x: 0.68, y: 0.5, role: 'AT', label: 'BU' },
  ],
  '4-2-4': [
    { x: 0.04, y: 0.5, role: 'GK', label: 'G' },
    ...
    { x: 0.15, y: 0.62, role: 'DF', label: 'DC' },
    { x: 0.18, y: 0.84, role: 'DF', label: 'DD' },
    { x: 0.38, y: 0.38, role: 'MD', label: 'MDC' },
    { x: 0.38, y: 0.62, role: 'MD', label: 'MDC' },
    { x: 0.62, y: 0.12, role: 'AT', label: 'AG' },
    { x: 0.68, y: 0.38, role: 'AT', label: 'BU' },
    { x: 0.68, y: 0.62, role: 'AT', label: 'BU' },
    { x: 0.62, y: 0.88, role: 'AT', label: 'AD' },
  ],
  '3-4-3': [
    { x: 0.04, y: 0.5, role: 'GK', label: 'G' },
    { x: 0.16, y: 0.3, role: 'DF', label: 'DC' },
    { x: 0.14, y: 0.5, role: 'DF', label: 'DC' },
    { x: 0.16, y: 0.7, role: 'DF', label: 'DC' },
    { x: 0.44, y: 0.10, role: 'MD', label: 'MG' },
    { x: 0.40, y: 0.38, role: 'MD', label: 'MC' },
    { x: 0.40, y: 0.62, role: 'MD', label: 'MC' },
    { x: 0.44, y: 0.90, role: 'MD', label: 'MD' },
    { x: 0.64, y: 0.16, role: 'AT', label: 'AG' },
    { x: 0.68, y: 0.5, role: 'AT', label: 'BU' },
    { x: 0.64, y: 0.84, role: 'AT', label: 'AD' },
  ],
  '5-4-1': [
    { x: 0.04, y: 0.5, role: 'GK', label: 'G' },
    { x: 0.20, y: 0.08, role: 'DF', label: 'DG' },
